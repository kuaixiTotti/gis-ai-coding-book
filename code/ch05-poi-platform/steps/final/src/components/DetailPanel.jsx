export default function DetailPanel({ poi, onClose }) {
  ...
  return (
    <div
      className="absolute z-10 bg-white shadow-xl p-6 overflow-y-auto
                 transition-transform duration-300
                 bottom-0 left-0 right-0 h-[50vh] w-full
                 md:top-0 md:right-0 md:left-auto md:bottom-auto md:h-full md:w-80"
    >
      <button
        onClick={onClose}
